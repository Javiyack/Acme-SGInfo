...
<%@ attribute name="confirmationMsg" required="false" %>
...
<jstl:if test="${confirmationMsg == null}">
    <jstl:set var="confirmationMsg" value="label.none"/>
</jstl:if>
...
<button type="button" onclick="${js}" class="${cssVar}" id="${id}" title="${title}">
