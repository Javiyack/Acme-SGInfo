...
public class ManagerIncidenceController extends AbstractController {
	...
	// Services
		...
		public ManagerIncidenceController() {
			super();
		}
		// List All incidences
		// ---------------------------------------------------------------
		...
		public ModelAndView save(@Valid final IncidenceForm incidence, final BindingResult binding) {
			...
			if (binding.hasErrors())
				...
				try {
					...
					result = this.createEditModelAndView(incidence, "manager.commit.error");
				}
			return result;
		}
