...
@Controller
@RequestMapping("/incidence/responsable")
public class ResponsableIncidenceController extends AbstractController {
	...
	public ResponsableIncidenceController() {
		super();
	}
	...
	public ModelAndView save(@Valid final IncidenceForm incidence, final BindingResult binding) {
		...
		if (binding.hasErrors())
			...
			try {
				...
				result = new ModelAndView("redirect:/incidence/responsable/list.do");
	...
	protected ModelAndView createEditModelAndView(final IncidenceForm incidence, final String message) {
		...
		result.addObject("requestUri", "incidence/responsable/edit.do");
