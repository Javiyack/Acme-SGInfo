...
@Controller
@RequestMapping("/location/technician")
public class TechnicianLocationController extends AbstractController {
	...
	public TechnicianLocationController() {
		super();
	}
	...
	public ModelAndView list() {
		...
		result = new ModelAndView("incidence/technician/list");
	...
	protected ModelAndView createEditModelAndView(final Incidence incidence, final String message) {
		...
		result = new ModelAndView("incidence/technician/create");
		result.addObject("incidence", incidence);
		result.addObject("message", message);
		result.addObject("requestUri", "incidence/technician/create.do");
	...
	protected ModelAndView createEditModelAndView(final IncidenceForm incidence, final String message) {
		...
		result = new ModelAndView("incidence/technician/register");
		result.addObject("incidence", incidence);
		result.addObject("message", message);
		result.addObject("requestUri", "incidence/technician/register.do");
